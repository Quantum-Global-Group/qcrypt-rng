...
import { ArrowLeft, Binary, FlaskConical, KeyRound } from 'lucide-react';
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-12 lg:gap-12">
        <div className="space-y-10 lg:col-span-7">
          <section aria-labelledby="step-family">
            <h2 id="step-family" className="mb-4 font-label text-[10px] font-semibold uppercase tracking-[0.12em] text-outline">
              01 · Algorithm family
            </h2>
          ...
          <section aria-labelledby="step-algo">
            <h2 id="step-algo" className="mb-4 font-label text-[10px] font-semibold uppercase tracking-[0.12em] text-outline">
              02 · Algorithm
            </h2>
          ...
          <section aria-labelledby="step-encoding">
            <h2 id="step-encoding" className="mb-4 font-label text-[10px] font-semibold uppercase tracking-[0.12em] text-outline">
              03 · Encoding
            </h2>
        ...
        <aside className="lg:col-span-5">
          <div className="sticky top-24 flex flex-col gap-5 rounded-xl border border-outline-variant/20 bg-surface-container-low/70 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
            <div>
              <h2 className="font-label text-[10px] font-semibold uppercase tracking-[0.12em] text-outline">Output</h2>
            ...
            {result ? (
              ...
              <div className="rounded-lg border border-dashed border-outline-variant/30 bg-surface-container-lowest/50 px-4 py-8 text-center">
                <p className="text-sm text-on-surface-variant">Generated keys will appear here.</p>
              </div>
            )}

            <Link
              href="/pqc"
              className="inline-flex items-center gap-2 border-t border-outline-variant/15 pt-5 text-sm font-medium text-primary transition-colors hover:text-primary/90"
            >
