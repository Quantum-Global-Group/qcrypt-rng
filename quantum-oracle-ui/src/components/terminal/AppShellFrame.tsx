...
export const AppShellFrame = ({ children }: { children: React.ReactNode }) => {
  ...
  const baseCommands: PaletteCommand[] = [
    ...
    {
      id: 'go-scenarios',
      label: 'goto scenarios',
      hint: '/scenarios — flagship workflow guides',
      group: 'Navigate',
      run: () => (window.location.href = '/scenarios'),
    },
    {
      id: 'go-scenario-lottery',
      label: 'goto scenario / lottery',
      hint: '/scenarios/lottery',
      group: 'Navigate',
      run: () => (window.location.href = '/scenarios/lottery'),
    },
    {
      id: 'go-scenario-sealed-bid',
      label: 'goto scenario / sealed-bid',
      hint: '/scenarios/sealed-bid',
      group: 'Navigate',
      run: () => (window.location.href = '/scenarios/sealed-bid'),
    },
    {
      id: 'go-scenario-committee',
      label: 'goto scenario / committee',
      hint: '/scenarios/committee',
      group: 'Navigate',
      run: () => (window.location.href = '/scenarios/committee'),
    },
    {
